...
def eth():
    ...
    print("="*44)
def btc():
    chaper_url = 'https://api-otc.huobi.pro/v1/otc/trade/list/public?coinId=1&tradeType=1&currentPage=1&payWay=&country=&merchant=0&online=1&range=0'
    # 定义一个网站头UA
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:23.0) Gecko/20100101 Firefox/23.0'}
    req = urllib.request.Request(url=chaper_url, headers=headers)
    # 输出结果转码utf-8
...
while True:
    userInput = input("请输入查询挂单的指令 B E U :")
